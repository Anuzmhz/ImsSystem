                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="stockAvailable" value="{{$data[0]->stock_available }}" name="stockAvailable" placeholder="Stock Available" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="purchasePrice" class="col-sm-4 col-form-label">Purchase Price</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="purchasePrice" value="{{$data[0]->purchase_price }}" id="purchasePrice" placeholder="Purchase Price" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="sellingPrice" class="col-sm-4 col-form-label">Selling Price</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="sellingPrice" value="{{$data[0]-> selling_price}}"id="sellingPrice" placeholder="Selling Price" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea name ="information" class="form-control" rows="5" disabled>"{{$data[0]->information }}"</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
