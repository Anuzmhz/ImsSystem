                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="address" name="address" value="{{ $data[0]->address }}" placeholder="Address">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <label for="address" class="col-sm-4 col-form-label">Contact Person</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="contactperson" name="contactperson" value="{{ $data[0]->cp }}" placeholder="ContactPerson">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="phone" id="phone" value="{{ $data[0]->phone }}" placeholder="Phone No">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
